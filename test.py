...
Preprocessor(10000).preprocess("data/crp_slice.csv")
...
preprocessor.path = "data/crp_slice.csv"
preprocessor._group_by_last_name()
...
for last_name, matches in preprocessor.last_name_groups.iteritems():
    if len(matches) < 2:
        continue
    print last_name
